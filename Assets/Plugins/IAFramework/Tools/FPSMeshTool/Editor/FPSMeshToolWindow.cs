...
namespace CBG.FPSMeshTool {
    ...
    public class FPSMeshToolWindow : EditorWindow {
        ...
        void BuildFPSMesh() {
            ...
            // Create prefab and keep scene instance connected.
            string prefabPath = GetValidAssetName(GeneratePrefabFileName(previewInstance));
            PrefabUtility.SaveAsPrefabAssetAndConnect(previewInstance, prefabPath, InteractionMode.UserAction);
